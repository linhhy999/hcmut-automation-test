...
(async function example() {
    ...
    try {
        ...
        // click menu DM
        // await driver.wait(until.elementLocated(By.linkText('Danh mục')), 10000);
        // linkText = await driver.findElement(By.linkText('Danh mục'))
        // await driver.wait(until.elementIsVisible(linkText), 10000);
        // await linkText.click();
        await UserPage.clickSubMenu("Ngạch");
        // click submenu ngach
        // await driver.wait(until.elementLocated(By.linkText('Ngạch')), 10000);
        // linkText = await driver.findElement(By.linkText('Ngạch'))
        // await driver.wait(until.elementIsVisible(linkText), 10000);
        // await linkText.click();
